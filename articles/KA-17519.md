...
<b>[!DNL Import] [!DNL dbdBuilder.xml]</b>
<br><br><br><br> <br><br>
...
- The attached files, [!DNL database].xsl, and styles.xml (see [!DNL attachments].zip).
...
2. From the Campaign Console, go to Administration  Configuration  Package Management  Package definitions, and create a [!UICONTROL package].xml file that contains the data schemas (xtk:schema).
