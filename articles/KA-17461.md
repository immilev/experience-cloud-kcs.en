   ...
   - &#x200B;
      ...
      - &#x200B;
         ...
         - &#x200B;
            ...
            - On IIS, this can be controlled via the [[!UICONTROL dynamicTypes] configuration](https://docs.microsoft.com/en-us/iis/configuration/system.webserver/httpcompression/).
...
Be careful for the [Vary](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Vary) response header.  In certain cases, <b>Vary</b> can cause both the CDN and browser to skip caching entirely.  As a general rule of thumb, avoid adding <b>Vary</b> except for <b>[!UICONTROL Vary: Accept-Encoding] </b>(applied only when the response is gzip compressed).  In other words, if you need to "vary" the output of a response, use a different URL.
