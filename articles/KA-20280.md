...
This issue might occur if Commerce [!DNL Cloud Config] is not set on the page properties under [!UICONTROL Advanced] tab. Usually set this commerce cloud config on the site root page or landing page level in the content tree.
