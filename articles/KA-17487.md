...
<br><br><br><br><br> <br><br>
We know that when the httpd service starts up it pulls in the variables set by AMS in <b>[!DNL /etc/sysconfig/httpd]</b> and has the variable set of <b>ENV_TYPE</b> and <b>RUNMODE</b>
