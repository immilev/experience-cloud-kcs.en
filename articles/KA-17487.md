...
- Toggle features and change log levels of immutable files [!DNL AMS] provides and won't let you change.
...
AMS will put global variables in the startup arguments of the apache process inside the file <b>[!DNL /etc/sysconfig/httpd]</b>
...
Custom variables provided by your code should live in *.vars*files inside the directory <b>[!DNL /etc/httpd/conf].d/variables/</b>
...
<b>[!DNL /etc/httpd/conf].d/variables/weretail_domains_dev.vars</b>
...
<b>[!DNL /etc/httpd/conf].d/variables/weretail_domains_preview.vars</b>
