---
title: Access to [!UICONTROL Bot Rules] in the report suite settings
...
---
# Access to [!UICONTROL Bot Rules] in the report suite settings
...
Access to [!UICONTROL Bot Rules] is only restricted to Product Administrators.
