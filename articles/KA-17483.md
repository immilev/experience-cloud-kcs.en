...
article-published-date: "10/10/2022 6:45:18 PM"
version-number: 2
...
<br><br><br> <br><br>
When AMS provisions a system they roll out a baseline configuration that makes everything functional and secure.  These aren't things that AMS wants to ensure stay as a baseline of functionality and security.  To accomplish this some files are marked as read-only and immutable to avoid you changing them.
...
Variables allow you to make functional changes without changing the configurations files themselves.  Certain elements of the configuration can be adjusted with adjusting the values of variables.  One example we can highlight from the file */etc/httpd/conf.d/dispatcher_vhost.conf* is shown here:
