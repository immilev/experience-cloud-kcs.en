...
3. Add the properties highlighted below 1 to the corresponding indexes.  The <b>includedPaths</b> and <b>excludedPaths</b> properties should be multi-value String ( String )
4. Click "[!UICONTROL Save All]" in CRXDe
