...
The operators need to have access to the [!UICONTROL Campaign workflows] folder under [!UICONTROL Administration] - [!UICONTROL Production] - [!UICONTROL Objects created automatically] path.
