...
2. Select “Custom Code” from [!UICONTROL Action Type] drop down.
...
(function() &lbrace;    'use strict';
    // Export symbols.
    window.Configuration = &lbrace;
        PLAYER: &lbrace;
...
<b>STEP 4: Add [!DNL Actions Visitor ID Service]</b>
...
Once, you have downloaded Visitor ID Service code, click on + button under [!UICONTROL actions] to create a new action item, then
...
var visitor = Visitor.getInstance("Experience Cloud ID", &lbrace;
trackingServer: "tracking server", // same as s.trackingServer
trackingServerSecure: " tracking server " // same as s.trackingServerSecure
&rbrace;);

<b>STEP 5: Add Actions – [!DNL Appmeasurement] code</b>
...
Once, you have downloaded the Heartbeat code, click on + button under [!UICONTROL actions] to create a new action item, then
...
var player;
function onYouTubeIframeAPIReady() &lbrace;
       console.log("onYouTubeIframeAPIReady called...");
       player = new YT.Player('player', &lbrace;
              height: '390',
              width: '640',
              videoId: 'xWYHvIjvMnY',
              events: &lbrace;
...
function onPlayerReady(event) &lbrace;
       metaDataLoaded = true;
       player.playVideo();
&rbrace;
...
function onPlayerStateChange(event) &lbrace;
       switch (event.data)&lbrace;
              case YT.PlayerState.PLAYING:  console.log("\*\*\*HB Playing");
                     if(metaDataLoaded)&lbrace;
                            if (Math.floor(event.target.getCurrentTime()) == 0) &lbrace;
...
                                   mediaDelegate.getCurrentPlaybackTime = function() &lbrace;
...
function onPlayerPlaybackQualityChange(event) &lbrace;
       console.log("onPlayerPlaybackQualityChange: event.data: "+ event.data);
&rbrace;

function onPlayerPlaybackRateChange(event) &lbrace;
       console.log("onPlayerPlaybackRateChange: event.data: "+ event.data);
&rbrace;

function onPlayerError(event) &lbrace;
