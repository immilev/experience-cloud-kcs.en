...
Currently, there is an ongoing effort to replace IE with [!DNL Edge]. [!DNL Edge] is based on Chromium and does not have these URL restrictions. This has been confirmed by copying/pasting the long URL into [!DNL Edge] which does not truncate the URL and opens the report without any issues:
