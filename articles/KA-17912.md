...
Dispatcher controls what qualifies as cacheable in the /cache &lbrace; section of any farm file. 
...
Here is a base author /cache &lbrace; section of our author farm file:
...
One of the normal behaviors of the Dispatcher module is that if a request has a query parameter in the URI (typically shown like [!DNL /content/page].html<b>?myquery=value</b>) it will skip caching the file and go directly to the AEM instance. It's considering this request a dynamic page and shouldn't be cached. This can cause i'll effects on cache efficiency.
...
[[!DNL https]://www.retail.com/home.html?reference=android](https://www.retail.com/home.html?reference=android)

[[!DNL https]://www.retail.com/home.html?reference=facebook](https://www.retail.com/home.html?reference=facebook)
...
If you have 5 request to invalidate [!DNL /content/exampleco/en/] all happen within a 3 second period.

With this feature off you'd invalidate the cache directory [!DNL /content/exampleco/en/] 5 times
