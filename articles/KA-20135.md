...
`AEM as a Cloud Service does not offer configurable IP block lists out of the box. Hence use [!UICONTROL Apache mod_redirect] or any other approved module on the dispatcher at project level.`
