...
<br><br><br><br>What are Vanity URLs<br><br><br><br><br><br>
...
For this feature to work you'll have to adjust the [!DNL Dispatcher] filters to allow the vanity through.  This becomes unreasonable to do with adjusting the [!DNL Dispatcher] configuration files at the rate that authors would need to setup these vanity page entries.

For this reason the [!DNL Dispatcher] module has a feature to auto-allow anything listed as a vanity in the content tree.


## Resolution

<br><br>How it works<br><br><br><br><br><br>Authoring Vanity URLs<br><br><br><br><br><br>
...
Thes maps are visible by visiting the AEM instances [!DNL Felix] console ( <b>`/system/console/jcrresolver` </b>)

Here is a screenshot of the a map entry created by a vanity entry:
![console screenshot of a vanity entry in the resource resolving rules](https://helpx.adobe.com/content/dam/help/en/experience-manager/kb/ams-dispatcher-manual/disp-vanity-url/jcr_content/main-pars/image_228354446/vanity-resource-resolver-entry.png "vanity-resource-resolver-entry")<br><br><br><br> <br><br>
...
<br><br><br><br> <br><br>[!DNL Dispatcher] auto-allow filters<br><br><br><br> <br><br>
The [!DNL Dispatcher] in a secure state filters out requests at the path `/` through the [!DNL Dispatcher] because that's the root of the JCR tree.
...
Simple dispatcher has an auto-filter allow mechanism and you have to install an AEM package and then configure the [!DNL Dispatcher] to point to that packages page.

[https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/granite/vanityurls-components](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/granite/vanityurls-components)

[!DNL Dispatcher] has a configuration section in it's farm file:
...
This configuration tells the [!DNL Dispatcher] to fetch this URL from it's AEM instance it fronts every 300 seconds to fetch the list of items we want to allow through.
...
![screenshot of the content rendered from /libs/granite/dispatcher/content/vanityUrls.html](https://helpx.adobe.com/content/dam/help/en/experience-manager/kb/ams-dispatcher-manual/disp-vanity-url/jcr_content/main-pars/image_348723126/vanity-url-component.png "vanity-url-component")<br><br><br><br> <br><br>
It's literally a list, super simple
<br><br><br><br> <br><br>Rewrite Rules as Vanity Rules<br><br><br><br> <br><br>
...
Let's go over an example of the vanity entry *`/aboutus`* to it's content *`/content/we-retail/us/en/about-us.html`* using [!DNL Apache]'s `mod_rewrite` module to accomplish this.
<br><br><br><br><br> <br><br><br><br>
...
To create a rewrite rule to do this you would create a configuration file on the [!DNL Dispatcher] (example: `/etc/httpd/conf.d/rewrites/examplevanity_rewrite.rules`) and include it in the `.vhost` file that handles the domain that needs these vanity urls to apply.
...
<br><br><br><br><br> <br><br>Which Method and Where<br><br><br><br> <br><br>
