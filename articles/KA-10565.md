...
keywords: KCS, [!UICONTROL connect], [!UICONTROL Brand Portal], [!UICONTROL replication agent], [!UICONTROL JWT has expired], AEM, Adobe Experience Manager, [!UICONTROL 6.2], [!UICONTROL error]
...
The difference causes the expiration of the JWT.
...
1. Confirm the OS time of AEM.
2. Change the time to a valid time or use ntp.
