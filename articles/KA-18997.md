...
Ask the customer to whitelist the following DNS/IPs in case you see Timeout or other 400 messages in these requests in the Network or in the [!UICONTROL Console] tab from Chrome Developer Tools:
