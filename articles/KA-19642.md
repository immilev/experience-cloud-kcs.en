...
You can quickly look up the Search Engines registered in Adobe Analytics at [!UICONTROL Paid Search Detection] menu.

1. Login Adobe Analytics
2. [!UICONTROL Admin]  » [!UICONTROL Report Suites]  » [!UICONTROL Edit Settings]  » [!UICONTROL Paid Search Detection]
3. Look up [!UICONTROL Search Engine] from drop down scroll bar
