...
You can see Local [!UICONTROL References] of an asset on References tab of Properties. (In [!DNL Assets] Console, select an asset, select [!UICONTROL Properties] from the toolbar, and then select [!UICONTROL References] tab.) When you use the information outside AEM, you can export them in JSON format.
