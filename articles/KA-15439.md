...
The <b>*classpath</b>*tag from the [!DNL serverConf].xml configuration file has not been updated correctly after the upgrade. The *classpath* tag should point to the latest JARs.
