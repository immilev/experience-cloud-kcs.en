...
11. Later you can go to [!UICONTROL Workflows] View folder and search <b>*mdata contains login=”username”</b><ex id="2"/> to search for other such workflows which might be impacted.*
