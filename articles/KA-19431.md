---
title: Can [!DNL Litmus] Integration be moved from Prod to Staging
...
---
# Can [!DNL Litmus] Integration be moved from Prod to Staging
...
No, [!DNL Litmus] Integration cannot be moved from Prod to Staging neither it can be done on staging.
