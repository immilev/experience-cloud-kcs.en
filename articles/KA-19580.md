...
The issue is reproducible when at step 8 in 1, the URL <b>http://aem_server:port/assets.html/content/dam</b> is used for the connection with the [!DNL Experience Manager] repository instead of <b>http://aem_server:port</b>.
