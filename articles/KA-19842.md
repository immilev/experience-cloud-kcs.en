...
According to 2 the cq:tags property is a "String Array" so it should be a multi-valued property, while in this case, it was of [!UICONTROL type] String.
