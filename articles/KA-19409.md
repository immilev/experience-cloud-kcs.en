---
title: "[!UICONTROL File collector] activity alternative in ACS"
...
---
# [!UICONTROL File collector] activity alternative in ACS

## Description

As we do not have the [!UICONTROL File collector] activity in ACS, you can build it using the following activities and you will get more or less same functionality
...
The [!UICONTROL File collector] will allow downloading multiple files based on filename pattern from an external server. Each file is passed into the [!UICONTROL Load file] activity, giving data into the update.
Once completed, it continues with the following file and so on.
The File Transfer also has the [!UICONTROL Historization settings], as you know it from [!UICONTROL File collector].
